...
) : IMovieDetailAggregatorService
{
        ...
        QueryParameters queryParameters, CancellationToken cancellationToken)
    {
        try
        {
            logger.LogInformation("Searching: {queryParameters} class: {nameof(GetType)}", queryParameters, nameof(GetType));
            ...
            logger.LogInformation("Searched: {queryParameters} class: {nameof(GetType)}", queryParameters, nameof(GetType));
